...
#
# Prediction: error
# Verified Result: (What does the program print?) in python funcs are always defined in the order they are used


# --- Modification 2 ---
# Go back to the original code. Change the `celsius` variable to `25.5`.
#
# Prediction: What will the new Fahrenheit value be? Will the data type of the `fahrenheit` variable change?
# Verified Result: floating, 77.9
...
#
# Prediction: What kind of error do you think this will cause and why? error
# Verified Result: trying to use a string as a numeric value
