...
#
#     Your Answer: i get an error: 'math' not define; this library includes the pi and radius functions
#
# 2.  What is `math.pi`? Based on how it's used, do you think it is a
#     function or a variable defined inside the `math` module?
#
#     Your Answer: math.pi is function provided by math module.
#
...
#
#     Your Answer: radius ** 2 done first since it's an exponent.
